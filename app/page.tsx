            ...
            <section className="dream">
                ...
                <div className="content">
                    <figure className="worker">
                        <figcaption>Chaque projet est unique et mérite une attention personnalisée. Skybound Studio vous accompagne pour valoriser votre savoir-faire avec rigueur et passion.</figcaption>
                    ...
                    <figure className="worker">
                        ...
                        <figcaption>De la conception à la réalisation, l’objectif est d’assurer une présence digitale claire, performante, et qui reflète pleinement votre identité.</figcaption>
                    </figure>
                </div>
            </section>
