...
const { fillContactForm, expectFormErrors, mockFetchError, mockFetchNetworkError, mockFetch, cleanupMocks, setupTimers, cleanupTimers } = (global as any).testUtils;
describe('ContactForm', () => {
    beforeEach(() => { cleanupMocks(); render(<Contact />); });
    ...
    test('validation spécifique des champs', () => {
        const testCases = [
            { field: /nom/i, value: 'A' }, { field: /e-mail/i, value: 'invalid' },
            { field: /téléphone/i, value: '123' }, { field: /message/i, value: 'Court' },
        ];
